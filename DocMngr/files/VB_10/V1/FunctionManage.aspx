...
(case when active = 0 then 'FALSE' else 'TRUE' end) as active from functions"></asp:SqlDataSource>
        <asp:GridView ID="tblFunction" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                <asp:BoundField DataField="row_num" HeaderText="STT">
                    <ItemStyle Width="50px"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="function_code" HeaderText="Mã chức năng">
                    <ItemStyle Width="70px"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="function_name" HeaderText="Tên chức năng">
                    <ItemStyle Width="50px"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="function_path" HeaderText="Đường dẫn">
                    <ItemStyle Width="120px"></ItemStyle>
                </asp:BoundField>
                <asp:CheckBoxField DataField="active" HeaderText="Khả dụng" ReadOnly="true">
                    <ItemStyle Width="50px"></ItemStyle>
                </asp:CheckBoxField>
            </Columns>
