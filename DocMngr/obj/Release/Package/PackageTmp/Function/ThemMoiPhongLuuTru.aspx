...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td colspan="3">
        <asp:TextBox ID="txtNhomTaiLieu" runat="server" Width="625px" Rows="2" 
   ...
   <td>Các loại hình tài liệu khác</td>
    <td colspan="3">
        <asp:TextBox ID="txtTaiLieuKhac" runat="server" Width="625px" Rows="2" 
            TextMode="MultiLine"></asp:TextBox>
  ...
  <tr>
   ...
   <td>Công cụ tra cứu</td>
    <td colspan="3">
        <asp:TextBox ID="txtCongCu" runat="server" Width="625px" Rows="2" 
            TextMode="MultiLine"></asp:TextBox>
   ...
   <td>Lập bản sao bảo hiểm</td>
    <td colspan="3">
        <asp:TextBox ID="txtBaoHiem" runat="server" Width="625px" Rows="2" 
            TextMode="MultiLine"></asp:TextBox>
