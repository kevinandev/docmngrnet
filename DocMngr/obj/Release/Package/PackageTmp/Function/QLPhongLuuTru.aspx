<%@ Page Title="Quản lý phông lưu trữ" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="QLPhongLuuTru.aspx.cs" Inherits="Function.QLPhongLuuTru" %>
        ...
        <div id="divInput">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCoquan" runat="server" Height="25px" Width="327px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtKeyword" runat="server" Width="713px" />
                    </td>
                </tr>
                <tr>
                    <td>
