<%@ Page Title="Quản lý thời hạn bảo quản" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="QLThoiHanBaoQuan.aspx.cs" Inherits="Picklist.QLThoiHanBaoQuan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <label style="font-size: larger; font-weight: bold; margin-bottom: 10px">
            QUẢN LÝ DANH MỤC LOẠI THỜI HẠN BẢO QUẢN
        </label>
        <div id="divInput">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbxName" runat="server" Width="408px"  TextMode="MultiLine" Rows="2" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tbxDescription" runat="server" Width="752px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="dgvApprover" runat="server" AutoGenerateColumns="False" PageSize="20"
                            AllowSorting="True" AllowPaging="True" OnPageIndexChanging="dgvApprover_PageIndexChanging" ShowHeader="true">
