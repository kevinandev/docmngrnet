<%@ Page Title="Quản lý mức độ tin cậy" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLMucDoTinCay.aspx.cs" Inherits="Picklist.QLMucDoTinCay" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ MỨC ĐỘ TIN CẬY </label>
        <div id="divInput">
            <table>
                <tr>
