<%@ Page Title="Quản lý chế độ sử dụng" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLCheDoSuDung.aspx.cs" Inherits="Picklist.QLCheDoSuDung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ CHẾ ĐỘ SỬ DỤNG </label>
        <div id="divInput">
            <table>
                 <tr>
