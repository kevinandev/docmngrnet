<%@ Page Title="Quản lý ngôn ngữ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLNgonNgu.aspx.cs" Inherits="Picklist.QLNgonNgu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ DANH MỤC NGÔN NGỮ  </label>
         <div id="divInput">
            <table>
                <tr>
