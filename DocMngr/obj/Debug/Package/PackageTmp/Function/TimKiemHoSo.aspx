<%@ Page Title="Tìm kiếm hồ sơ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TimKiemHoso.aspx.cs" Inherits="Function.TimKiemHoso" %>
...
<div>
    <table width="90%">
    <tr><td colspan="4"><b> TÌM KIẾM HỒ SƠ</b></td></tr>
    <tr><td>Cơ quan lưu trữ</td><td>
      ...
      <tr><td>Thời hạn bảo quản </td><td>
        ...
        <td>Chế độ sử dụng </td><td>
         ...
         <tr><td>Thời gian bắt đầu từ ngày</td><td>
                   <asp:TextBox ID="txtThoiGianStartFrom" runat="server" ReadOnly = "true" Width="200px"></asp:TextBox>
                   <asp:Image ID="Image1" runat="server" ImageUrl="~/Styles/calender.png" />
                    </td>
        <td>Đến ngày</td><td>
         <asp:TextBox ID="txtThoiGianStartTo" runat="server"  ReadOnly = "true" Width="200px"></asp:TextBox>
          <asp:Image ID="Image3" runat="server" ImageUrl="~/Styles/calender.png" />
        </td>    </tr>
         <tr><td>Thời gian kết thúc từ ngày</td><td>
                   <asp:TextBox ID="txtThoiGianEndFrom" runat="server" ReadOnly = "true" Width="200px"></asp:TextBox>
                   <asp:Image ID="Image2" runat="server" ImageUrl="~/Styles/calender.png" />
                    </td>
        <td>Đến ngày</td><td>
         <asp:TextBox ID="txtThoiGianEndTo" runat="server"  ReadOnly = "true" Width="200px"></asp:TextBox>
...
<ItemStyle Width="80px"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="Chi tiết" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="80px" Visible="true" >
                        <ItemTemplate>
                            <asp:ImageButton ID="bt_changing" ToolTip ="Chi tiết" runat="server" ImageUrl="../Styles/icon_view.gif" Height="20px" Width="20px"  CommandArgument = '<%# Eval("ID") %>' BorderWidth="0" OnClick = "changing" />
                        </ItemTemplate>
