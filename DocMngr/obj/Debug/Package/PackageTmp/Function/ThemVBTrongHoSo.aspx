<%@ Page Title="Thêm văn bản vào hồ sơ " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ThemVBTrongHoSo.aspx.cs" Inherits="Function.ThemVBTrongHoSo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <table>
    ...
    <td colspan="3">
        <asp:DropDownList ID="ddlCoQuan" runat="server" Height="28px" Width="600px" 
            Enabled="False">
        </asp:DropDownList>
        </td>
    ...
    <td colspan="3">
          <asp:DropDownList ID="ddlPhong" runat="server" Height="37px" Width="600px" 
              Enabled="False">
        </asp:DropDownList>
        </td>
    ...
    <td>Bút tích</td>
    <td colspan="3">
        <asp:TextBox ID="txtButtich" runat="server" Width="600px"></asp:TextBox>
