<%@ Page Title="Chi tiết văn bản trong hồ sơ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChiTietVBTrongHoSo.aspx.cs" Inherits="Function.ChiTietVBTrongHoSo" %>
   ...
   <td></td>
    <td colspan="3">   
        <asp:Button ID="btAddApprover" runat="server" Text="Thêm mới" Width="120px" 
            onclick="btAddApprover_Click" Visible="False"  />
        <asp:Button ID="btCancel" runat="server" Text="Quay lại" Width="120px" 
            onclick="btCancel_Click" Visible="False" />
   </td>
    </tr>
