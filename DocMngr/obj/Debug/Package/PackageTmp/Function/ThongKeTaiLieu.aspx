<%@ Page Title="Thống kê tài liệu" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ThongKeTaiLieu.aspx.cs" Inherits="Function.ThongKeTaiLieu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div>
    <table width="90%">
    <tr><td colspan="4"> <b> THỐNG KÊ TÀI LIỆU</b></td></tr>
    <tr><td>Cơ quan lưu trữ</td><td>
      ...
      <tr><td>Ký hiệu văn bản </td><td>
          <asp:TextBox ID="txtKiHieuVanBan" runat="server" Width="200px"></asp:TextBox>
          </td>
        ...
        <td>&nbsp;</td>
        <td colspan ="3"> 
            <asp:Button ID="btTimKiem" runat="server" Text="Tìm Kiếm" Width="120px" 
...
<ItemStyle Width="120px"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="Sửa" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="80px" Visible="true" >
                        <ItemTemplate>
                            <asp:ImageButton ID="bt_changing" ToolTip ="Chỉnh sửa" runat="server" ImageUrl="~/Styles/Edit.gif" Height="20px" Width="20px"  CommandArgument = '<%# Eval("ID") %>' BorderWidth="0" OnClick = "changing" />
                        </ItemTemplate>

<ItemStyle HorizontalAlign="Center" Width="30px"></ItemStyle>
                        </asp:TemplateField>

                          <asp:TemplateField HeaderText="Chi tiết" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="60px" Visible="true" >
                        <ItemTemplate>
                            <asp:ImageButton ID="btView" ToolTip ="Chỉnh sửa" runat="server" ImageUrl="~/Styles/icon_view.gif" Height="20px" Width="20px"  CommandArgument = '<%# Eval("ID") %>' BorderWidth="0" OnClick = "viewing" />
                        </ItemTemplate>
