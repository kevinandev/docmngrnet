<%@ Page Title="Quản lý độ mật" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyDoMat.aspx.cs" Inherits="Picklist.QuanLyDoMat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ DANH MỤC ĐỘ MẬT </label>
        <div id="divInput">
            <table>
               <tr>
				...
				<tr>
					...
					<td><asp:TextBox ID="tbxDescription" runat="server" Width="752px"  TextMode="MultiLine" Rows="2" /></td>
                </tr>				
				<tr>
					<td><span class="textrequire">*</span>Cấp</td>
					<td>
											
					    <ew:NumericBox ID="ntbLayer" runat="server">0</ew:NumericBox>
			...
			<asp:Button ID="btCancel" runat="server" Text="Hủy bỏ" Width="100px" 
                ...
                PageSize="20" AllowSorting="True" AllowPaging="True" 
					onpageindexchanging="dgvApprover_PageIndexChanging" ShowHeader="true">			
                ...
                <asp:BoundField DataField="stt" HeaderText="STT" >
                    ...
                    <asp:BoundField DataField="Layer" HeaderText="Cấp" >
