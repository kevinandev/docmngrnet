<%@ Page Title="Quản lý loại văn bản" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoaiVanBan.aspx.cs" Inherits="Picklist.LoaiVanBan" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ DANH MỤC LOẠI VĂN BẢN</label>
        <div id="divInput">
            <table>
                <tr>
