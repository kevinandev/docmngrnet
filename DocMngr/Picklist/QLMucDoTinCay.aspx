<%@ Page Title="Quản lý mức độ tin cậy" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="QLMucDoTinCay.aspx.cs" Inherits="Picklist.QLMucDoTinCay" %>
        ...
        <div id="divInput">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbxDescription" runat="server" Width="752px"  TextMode="MultiLine" Rows="2" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
