<%@ Page Title="Quản lý tình trạng vật lý" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLTinhTrangVatLy.aspx.cs" Inherits="Picklist.QLTinhTrangVatLy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

 <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ TÌNH TRẠNG VẬT LÝ  </label>
        <div id="divInput">
            <table>
                <tr>
