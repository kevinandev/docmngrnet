<%@ Page Title="Quản lý mục lục" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLMucLuc.aspx.cs" Inherits="Function.QLMucLuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <label style="font-size: larger; font-weight:bold; margin-bottom: 10px">QUẢN LÝ MỤC LỤC HỒ SƠ </label>
        <div id="divInput">
            <table>
               <tr>
				...
				<tr>
					...
					<td><asp:TextBox ID="tbxDescription" runat="server" Width="752px" Rows="2" 
