<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="QLRole.aspx.cs" Inherits="Function.QLRole" %>
                ...
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="dgvApprover" runat="server" AutoGenerateColumns="False"
                            AllowSorting="True" AllowPaging="false" DataKeyNames="RoleId" BorderWidth="1px" OnRowDataBound="dgvOnDataBind" ShowHeader="true">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sửa" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="bt_changing" ToolTip="Sửa" runat="server" ImageUrl="~/Styles/edit.gif"
                                            Height="21px" Width="20px" BorderWidth="0"
                                ...
                                <asp:BoundField DataField="RoleName" HeaderText="Tên">
